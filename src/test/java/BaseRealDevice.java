...
public class BaseRealDevice {
    public static IOSDriver DesiredCapabilities() throws MalformedURLException {
        ...
        capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "iPhone mini");
        capabilities.setCapability(MobileCapabilityType.UDID, "73259133-FC57-42E4-AABC-A2B1E9DAA4BC");
        capabilities.setCapability(MobileCapabilityType.AUTOMATION_NAME, AutomationName.IOS_XCUI_TEST);
        capabilities.setCapability("xcodeOrgId","xxxxxxxx");
        capabilities.setCapability("xcodeSigningId","iPhone Developer");
        capabilities.setCapability("udid","xxxxxxxx");
        capabilities.setCapability("updateWDABundleId","xxxxxxx");
